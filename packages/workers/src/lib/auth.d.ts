...
export declare function generateAccessToken(payload: Omit<JWTPayload, 'iat' | 'exp'>, env?: any): Promise<string>;
export declare function generateRefreshToken(userId: string, tenantId: string, env?: any): Promise<string>;
